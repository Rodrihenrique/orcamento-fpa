  ...
  return (
    <>
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-1">
        <nav 
          className="bg-white/95 backdrop-blur-md border border-slate-200/90 shadow-lg shadow-slate-200/50 rounded-2xl p-1.5 flex items-center gap-1.5 overflow-x-auto scrollbar-none"
          aria-label="Navegação entre módulos"
        >
          <button
            onClick={() => setActiveTab('dashboard')}
            className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold transition-all duration-150 cursor-pointer whitespace-nowrap ${
              activeTab === 'dashboard'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold transition-all duration-150 cursor-pointer whitespace-nowrap relative ${
              activeTab === 'variance'
                ? 'bg-blue-600 text-white shadow-md shadow-blue-500/25'
                : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100/80'
            }`}
          ...
          >
            <Radio className={`w-4 h-4 ${activeTab === 'detraf' ? 'text-white' : 'text-emerald-500'}`} />
          ...
          >
            <Banknote className={`w-4 h-4 ${activeTab === 'cashflow' ? 'text-white' : 'text-indigo-500'}`} />
          ...
          >
            <Building2 className={`w-4 h-4 ${activeTab === 'contracts' ? 'text-white' : 'text-amber-500'}`} />
